      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex md:block gap-4 overflow-x-auto md:overflow-x-visible pb-4 md:pb-0 snap-x snap-mandatory md:snap-none no-visible-scrollbar md:space-y-4">
              {values.map((value, index) => (
                <motion.div
                  key={value.title}
                  className="glass-card p-6 rounded-xl min-w-[85vw] sm:min-w-[300px] md:min-w-0 md:w-full flex-shrink-0 md:flex-shrink snap-center md:snap-align-none"
        ...
        >
          <div className="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto md:overflow-x-visible pb-4 md:pb-0 snap-x snap-mandatory md:snap-none no-visible-scrollbar">
            <div className="glass-card p-6 rounded-xl min-w-[85vw] sm:min-w-[300px] md:min-w-0 flex-shrink-0 md:flex-shrink snap-center">
